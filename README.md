# FCC-DataAnalysis with Python
These are Python Challenges from the Data Analysis Certification (FreeCode Camp)
The challenge's are described thorugh the completion of the cert, each problem covers Data Analysis topics 
